      ...
      <div className="bodyDiv">
        <div className="app">
          ...
          <div className="imphalTopDiv">
            ...
            <div className="imphalDes">
              Imphal is the capital city of Manipur. It spans both the Imphal
              East and West districts. It is most famous for it's metropolitan
              centre which contains the ruins of Kangla Palace, the royal seat
              of the former Kingdom of Manipur. It's population was 268,243
              according to a 2011 census.
            </div>
          </div>
          <div className="nambolTopDiv">
            <div className="nambolPic"></div>
            <div className="nambolDes">
              The town of Nambol overlaps the Bishnupur and Imphal West
              districts. It is known as an educational hub and it's market
              called the Nambol Bazaar is one of the busiest markets in Manipur.
              In 2001 a census showed a population of 18,117.
            </div>
          </div>
          <div className="samurouTopDiv">
            <div className="samurouPic"></div>
            <div className="samurouDes">
              Samurou city limits reach into both the Thoubal and Imphal West
              districts. Notable spots include two temples for the diety of
              Ibudhou Pakhangba, Awang Leikai and Makha Leikai. It is also the
              birthplace of the Manipuri poet Hijam Angahal. As of 2001 it's
              population was 14,232.
            </div>
          </div>
          ...
          <div className="accessDiv">
            <p>Access to Anthony Maddox's:</p>
            <a
              className="apiLink"
              href="https://indian-cities-api.herokuapp.com/cities"
              target="_blank"
            >
              Indian Cities API
            </a>
        ...
        <div className="docDiv">
          Documentation for the Indian Cities API can be found
          <a
            className="apiLink"
            href="https://github.com/AnthonyMaddox/sei38-project6"
            target="_blank"
          >
            HERE
          </a>
